...
| `departments.txt` | 部局情報取得のためのインデックスツリー情報をまとめたファイル<br>（自動取得する場合、https://github.com/KGOS-Promotion/KGOS.code/tree/main/Index%20Tree%20Structure%20Retrieval%20Tool をご活用ください。）|
